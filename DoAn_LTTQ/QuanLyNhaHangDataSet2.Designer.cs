...
namespace DoAn_LTTQ {
    ...
    public partial class QuanLyNhaHangDataSet2 : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
            public EmployeeRow AddEmployeeRow(string Name, string Phone, string Position, decimal Salary, string Avatar) {
...
namespace DoAn_LTTQ.QuanLyNhaHangDataSet2TableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Employee] WHERE (([ID] = @Original_ID) AND ([Name] = @Original_Name) AND ([Phone] = @Original_Phone) AND ([Position] = @Original_Position) AND ([Salary] = @Original_Salary) AND ((@IsNull_Avatar = 1 AND [Avatar] IS NULL) OR ([Avatar] = @Original_Avatar)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employee] ([Name], [Phone], [Position], [Salary], [Avatar]) VA" +
                "LUES (@Name, @Phone, @Position, @Salary, @Avatar);\r\nSELECT ID, Name, Phone, Posi" +
                "tion, Salary, Avatar FROM Employee WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [Name] = @Name, [Phone] = @Phone, [Position] = @Position, [Salary] = @Salary, [Avatar] = @Avatar WHERE (([ID] = @Original_ID) AND ([Name] = @Original_Name) AND ([Phone] = @Original_Phone) AND ([Position] = @Original_Position) AND ([Salary] = @Original_Salary) AND ((@IsNull_Avatar = 1 AND [Avatar] IS NULL) OR ([Avatar] = @Original_Avatar)));
SELECT ID, Name, Phone, Position, Salary, Avatar FROM Employee WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DoAn_LTTQ.Properties.Settings.Default.QuanLyNhaHangConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Phone, Position, Salary, Avatar FROM dbo.Employee";
        ...
        public virtual int Fill(QuanLyNhaHangDataSet2.EmployeeDataTable dataTable) {
        ...
        public virtual QuanLyNhaHangDataSet2.EmployeeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            QuanLyNhaHangDataSet2.EmployeeDataTable dataTable = new QuanLyNhaHangDataSet2.EmployeeDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(QuanLyNhaHangDataSet2.EmployeeDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_Name, string Original_Phone, string Original_Position, decimal Original_Salary, string Original_Avatar) {
        ...
        public virtual int Insert(string Name, string Phone, string Position, decimal Salary, string Avatar) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Phone, string Position, decimal Salary, string Avatar, int Original_ID, string Original_Name, string Original_Phone, string Original_Position, decimal Original_Salary, string Original_Avatar, int ID) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Phone, string Position, decimal Salary, string Avatar, int Original_ID, string Original_Name, string Original_Phone, string Original_Position, decimal Original_Salary, string Original_Avatar) {
            return this.Update(Name, Phone, Position, Salary, Avatar, Original_ID, Original_Name, Original_Phone, Original_Position, Original_Salary, Original_Avatar, Original_ID);
        }
    }
